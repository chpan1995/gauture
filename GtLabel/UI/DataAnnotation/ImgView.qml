        ...
        Image {
            ...
            MouseArea {
                ...
                onPositionChanged: {
                    ...
                    if (imgname.mouseX < imgname.displayRect.x)
                        imgname.mouseX = imgname.displayRect.x;
                    ...
                    if (imgname.mouseY < imgname.displayRect.y)
                        imgname.mouseY = imgname.displayRect.y;
                    ...
                    if (canvas.isDrawing) {
                        // 获取原始图片坐标
                        let imageCoords = sourceImage.displayToImageCoordinates(imgname.mouseX, imgname.mouseY);
